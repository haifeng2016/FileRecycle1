...
public class DocListFileBean {
    ...
    public DocListFileBean(@NonNull String name, @NonNull String time,
    ...
    public DocListFileBean(@NonNull String name, @NonNull Date delTime,
                           @NonNull String size, @NonNull String path) {
        this.name = name;
