...
public class OtherFilesListAdapter extends RecyclerView.Adapter<OtherFilesListAdapter.CommonViewHolder> {
    ...
    public OtherFilesListAdapter(IFileSelected iFileSelected, List<FileBean> list) {
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_show_other_files_listitem, parent, false);
    ...
    class CommonViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommonViewHolder(View view) {
            ...
            nameTextView = (TextView) view.findViewById(R.id.otherfilesname);
            timeTextView = (TextView) view.findViewById(R.id.delete_time);
            sizeTextView = (TextView) view.findViewById(R.id.otherfilessize);
            selectedCheckBox = (CheckBox) view.findViewById(R.id.otherfilesselecectcheckbox);
