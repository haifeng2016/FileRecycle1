...
public class AppListAdapter extends RecyclerView.Adapter<AppListAdapter.CommonViewHolder> {
    ...
    public AppListAdapter(IFileSelected iFileSelected, List<FileBean> list) {
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_show_app_listitem, parent, false);
    ...
    class CommonViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommonViewHolder(View view) {
            ...
            nameTextView = (TextView) view.findViewById(R.id.appname);
            timeTextView = (TextView) view.findViewById(R.id.delete_time);
            sizeTextView = (TextView) view.findViewById(R.id.appsize);
            selectedCheckBox = (CheckBox) view.findViewById(R.id.appselecectcheckbox);
