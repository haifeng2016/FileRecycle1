...
/**
 * Created by haifeng on 2017/6/20.
 */

public class VideoListAdapter extends RecyclerView.Adapter<VideoListAdapter.CommonViewHolder> {
    ...
    public VideoListAdapter(IFileSelected iFileSelected, List<FileBean> list) {
    ...
    public CommonViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_show_video_listitem, parent, false);
    ...
    class CommonViewHolder extends RecyclerView.ViewHolder {
        ...
        public CommonViewHolder(View view) {
            ...
            sizeTextView = (TextView) view.findViewById(R.id.videosize);
            selectedCheckBox = (CheckBox) view.findViewById(R.id.videoselecectcheckbox);
