...
public class DocListAdapter extends RecyclerView.Adapter<DocListAdapter.CommonViewHolder> {
    ...
    public DocListAdapter(IFileSelected iFileSelected, List<FileBean> list) {
